...
import com.example.letschat.Adapter.MessagesAdater;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReciverImage=getIntent().getStringExtra("Reciverİmage");
      ...
      reciverRoom=ReciverUID+SenderUID;
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (message.isEmpty()){
                    Toast.makeText(ChatActivity.this, "Geçerli Mesaj Giriniz", Toast.LENGTH_SHORT).show();
                    return;
                }
                edtMessage.setText("");
                Date date=new Date();
