              ...
              String name =  setting_name.getText().toString();
               String status = setting_status.getText().toString();
                if (selectdImageUri!=null){
                    storageReference.putFile(selectdImageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        @Override
                                    ...
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                           if (task.isSuccessful()){
                                               ...
                                               Toast.makeText(SettingActivity.this, "Veri Güncellendi", Toast.LENGTH_SHORT).show();
                                               startActivity(new Intent(SettingActivity.this, HomeActivity.class));
                                           }else{
                                               progressDialog.dismiss();
                                               Toast.makeText(SettingActivity.this, "Birşeyler Yanlış Gitti", Toast.LENGTH_SHORT).show();
                                           }
                                        }
                                    });
                                }
    ...
    protected void onActivityResult(int requestCode,int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==10){
            if (data!=null){
                ...
                setting_image.setImageURI(selectdImageUri);
            }
        }
    }
}